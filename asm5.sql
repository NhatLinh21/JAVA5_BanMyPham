...
create table address(
	...
	DiaChi text,
	MaKH INT,
	CONSTRAINT fk_diachi FOREIGN KEY (MaKH) REFERENCES customer(MaKH)
)
CREATE TABLE status(
...
CREATE TABLE product (
	...
	ID int,
	MoTa nvarchar(max),
	CONSTRAINT fk_tt_sp FOREIGN KEY (ID) REFERENCES status(ID)
);
...
CREATE TABLE product_size (
	...
	dvtinh varchar(10),
    SoLuong INT,
    CONSTRAINT fk_pd_size FOREIGN KEY (id_size) REFERENCES size(id_size)
);
create table images(
	ID int identity primary key,
	Img  varchar(20) default 'default_value' null,
	MaSP varchar(10),
	CONSTRAINT fk_sp_img FOREIGN KEY (MaSP) REFERENCES product(MaSP)
)
CREATE TABLE orders (
    ...
    CONSTRAINT fk_makh_dh FOREIGN KEY (MaKH) REFERENCES customer(MaKH),
	CONSTRAINT fk_manv_dh FOREIGN KEY (MaNV) REFERENCES staff(MaNV)
);
...
CREATE TABLE orderdetail (
    ...
    CONSTRAINT fk_madh_ctdh FOREIGN KEY (MaDH) REFERENCES orders(MaDH),
	CONSTRAINT fk_sp_ctdh FOREIGN KEY (MaSP) REFERENCES product(MaSP),
	CONSTRAINT fk_dc_ctdh FOREIGN KEY (ID) REFERENCES address(ID),
	CONSTRAINT fk_size_ctdh FOREIGN KEY (id_size) REFERENCES size(id_size)
);
...
CREATE TABLE comment (
    ...
    Likes BIT,
	CTDH INT,
	CONSTRAINT fk_ctdh_dg FOREIGN KEY (CTDH) REFERENCES orderdetail(CTDH)
);
...
INSERT INTO customer(TenKH, Email, Pass, SDT)
VALUES
...
INSERT INTO address(DiaChi, MaKH) VALUES
...
INSERT INTO product(MaSP, TenSP, Hinh, ID ,MoTa) VALUES 
...
INSERT INTO orders (MaDH, MaKH, MaNV, NgayDat, NgayGiaoDuKien, DiaChi, TrangThai) VALUES 
...
INSERT INTO orderdetail(MaDH, MaSP, SoLuong, DonGia) VALUES 
...
INSERT INTO comment(MaDG,  SoSao, NoiDung, Images, NgayDG, Likes, CTDH) VALUES 
('DG001', 1, 5, N'Rất hài lòng với sản phẩm này.','', '2024-05-4 10:00:00', 1, 0, 1),
('DG002', 2, 4, N'Sản phẩm chất lượng, giao hàng nhanh chóng.','', '2024-05-4 11:00:00', 1, 0, 10),
('DG003', 3, 3, N'Giao hàng đúng hẹn, nhưng sản phẩm hơi bị trầy xước.','', '2024-06-01 12:00:00', 1, 0, 3),
('DG004', 4, 2, N'Sản phẩm không đúng mô tả, giao hàng muộn.','', '2024-06-06 13:00:00', 0, 1, 4);

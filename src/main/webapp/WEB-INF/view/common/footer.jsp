	...
	<div class="container-fluid tm-container-small">
		<div class="row">
			<div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
				<h3 class="tm-text-primary mb-4 tm-footer-title">Giải Trí Video Trong Tầm Tay</h3>
		...
		<div class="row">
			<div class="col-lg-8 col-md-7 col-12 px-5 mb-3">Copyright 2024
				NhatLinh. All rights reserved.</div>

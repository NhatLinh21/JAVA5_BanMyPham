						...
						<div class="col-md-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Add/Edit Sản Phẩm</h3>
								...
								<div class="card-body">
									<div class="form-group">
										<label for="title">Mã</label> <input type="text" id="title"
											value="" class="form-control">
									</div>
									<div class="form-group">
										<label for="href">Tên</label> <input type="text" id="href"
											value="" class="form-control">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-9">
												<div class="row">
													...
													<div class="col-12 form-group">
														<label for="poster">Hình</label> <input type="text"
